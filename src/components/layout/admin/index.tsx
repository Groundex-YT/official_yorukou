...
const AdminBaseLayout: React.FC<AdminBaseLayoutProps> = ({
    ...
    return (
        <main
            className={`relative text-white w-screen h-screen ${inter.className} overflow-hidden`}
        >
            <div className="absolute w-[750px] -left-1/4 -top-1/4 h-[570px] bg-gray-700 blur-[150px] rounded-full"></div>
